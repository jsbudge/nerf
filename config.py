...
def get_config(model='nerf', command_line=False, param_file=None):
    config = argparse.ArgumentParser()

    # basic hyperparams to specify where to load/save data from/to
    config.add_argument("--log_dir", type=str, default="logs")
    ...
    config.add_argument("--max_steps", type=int, default=2_500)
    ...
    base_data_path = "/home/jeff/repo/nerf/data/nerf_llff_data/"
    if config.dataset_name == "blender":
        base_data_path = "/home/jeff/repo/nerf/data/nerf_synthetic/"
    elif config.dataset_name == "multicam":
        base_data_path = "/home/jeff/repo/nerf/data/nerf_multiscale/"
